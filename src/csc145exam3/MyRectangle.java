 ...
 * Concentration: SD
 * Date: 04/03/2024
 * Java class description: Creates a custom rectangle class as a java.awt.rectangle as a base and adds more methods to it
 */
...
public class MyRectangle extends Rectangle {
  ...
  public int getPerimeter(){
      this.width = (int)Math.abs(this.x - this.x2);
      this.height = (int)Math.abs(this.y - this.y2);
